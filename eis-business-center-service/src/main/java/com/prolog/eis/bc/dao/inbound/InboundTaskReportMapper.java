 ...
 */
@Repository
public interface InboundTaskReportMapper extends BaseMapper<InboundTaskReport> {
    ...
    @Select({"<script>" +
            "select t.* \r\n" +
            "from biz_eis_inbound_task_rp t \r\n" +
            "where 1 = 1 \r\n" +
            ...
            "</script>"})
    @Results(id = "inboundTaskReportVoMap", value = {
    ...
    List<InboundTaskReportVo> findByParam(@Param("dto") InboundTaskReportDto dto);
}
